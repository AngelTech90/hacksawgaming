!function() {
    var e = {
        6114: function(e, a, t) {
            "use strict";
            var n = t(8991);
            Hacksaw.routes.common = {
                init: function() {
                    (0,
                    n.kc)(n.e0.cookies.default),
                    $(".js-cookies-consent").on("click", (e => {
                        e.preventDefault();
                        const a = e.currentTarget?.dataset.consent;
                        a === n.e0.cookies.default.values.accepted ? (0,
                        n.jW)() : (0,
                        n.W1)(),
                        (0,
                        n.Du)()
                    ...
                    const e = document.querySelectorAll(".lazy-bg")
                      , a = new IntersectionObserver((e => {
                        e.forEach((e => {
                            if (e.isIntersecting) {
                                const t = e.target.getAttribute("data-bg-image");
                    ...
                    var s = document.body
                      , r = (s.getAttribute("data-controller"),
                    s.getAttribute("data-action"));
                    window.innerWidth > 1200 && ($(".video-hero-wrapper").length > 0 || "open-rgs" == r) && (window.scrollY > 0 ? (t.classList.add("Navigation--fill"),
                    t.classList.add("shrink")) : (t.classList.remove("shrink"),
                    t.classList.remove("Navigation--fill"))),
                    addEventListener("scroll", (e => {
                        window.innerWidth > 1200 && (window.scrollY > 0 ? (t.classList.add("shrink"),
                        ($(".video-hero-wrapper").length > 0 || "open-rgs" == r) && t.classList.add("Navigation--fill")) : (t.classList.remove("shrink"),
                        ($(".video-hero-wrapper").length > 0 || "open-rgs" == r) && t.classList.remove("Navigation--fill")))
                    }
                    )),
                    $(".MobileMenuToggle2").on("click", (function() {
                    ...
                    $(".GridListItem").on("click", (function(e) {
                    ...
                    var i = (0,
                    n.p6)();
                    window.innerWidth <= 1200 ? ($(".NavList").find(".NavList__link").on("click", (e => {
                        $(e.target).siblings(".NavList__dropdown").length > 0 && (e.target.href = "javascript:void(0);",
                        $(".NavList__dropdown").toggleClass("expanded"))
                    }
                    )),
                    $(".NavList__dropdown--nav").find("button").on("click", (e => {
                        $(e.target).closest(".NavList__dropdown").removeClass("expanded")
                    }
                    ))) : "landscape" == i && ($(".NavList").find(".NavList__link").on("mouseenter", (e => {
                        $(".NavList__dropdown").css("display", "none"),
                        $(e.target.closest(".NavList__link")).siblings(".NavList__dropdown").css("display", "flex"),
                        $(e.target.closest(".NavList__link")).addClass("active")
                    }
                    )),
                    $(".NavList").find(".NavList__item").on("mouseleave", (e => {
                        $(".NavList__dropdown").css("display", "none"),
                        $(".NavList__link").removeClass("active")
                    }
                    ))),
                    $(".js-scroll-trigger").on("click", (function() {
                        var e = $(this).data("target");
                        $(".js-nav-close").parent().removeClass("is-active"),
                        $(".NavList").removeClass("is-active"),
                        $("html, body").animate({
                            scrollTop: $('[data-section="' + e + '"]').offset().top - $topBar.height() + 1
                        }, 1e3)
                    }
                    )),
                    $(window).trigger("scroll"),
                    window.innerWidth <= 1200 && $(".NavList__link.arrow.activated").siblings(".NavList__dropdown").addClass("expanded")
                }
            }
        },
        5810: function(e, a, t) {
            ...
            function s(e) {
                if ((0,
                n.A7)(n.e0.cookies.ageVerified.name) === n.e0.cookies.ageVerified.values.accepted) {
                    if (d = null,
                    "desktop" == i) {
                        var a = document.createElement("iframe");
                        a.setAttribute("id", "Game"),
                    ...
                    hacksaw.include("Game", t),
                    "desktop" == i && ($(".GamePlayer").addClass("is-active transition-in"),
                    setTimeout((function() {
                        $(".GamePlayer").removeClass("transition-out")
                    }
                    ), 500))
                } else
                    !function(e) {
                        r.addClass("is-active transition-in"),
                        d = e
                    }(e)
            }
            let r = $(".DialogWrapper")
            ...
            function o() {
                $(".js-launch-game").on("click", (function() {
                    s($(this).data("gameid"))
                }
                )),
                $(".js-responsible-decline").on("click", (function() {
                    r.addClass("transition-out"),
                    d = null,
                    setTimeout((function() {
                        r.removeClass("is-active transition-out")
                    }
                    ), 500)
                }
                )),
                $(".js-responsible-approve").on("click", (function() {
                    (0,
                    n.A7)(n.e0.cookies.default.name) === n.e0.cookies.default.values.accepted && (0,
                    n.d8)(n.e0.cookies.ageVerified.name, n.e0.cookies.ageVerified.values.accepted, 7),
                    r.addClass("transition-out"),
                    setTimeout((function() {
                        s(d)
                    }
            ...
            /iP(hone|od|ad)|Android/.test(_) && (i = "mobile"),
            $(".js-view-all-slots").on("click", (function() {
                $(this).hide(),
                $(".js-expanded-slot").show()
            }
            )),
            $(".js-view-all-scratchcards").on("click", (function() {
                $(this).hide(),
                $(".js-expanded-scratchcard").show()
            }
            )),
            $(".GamePlayerOverlay, .fa-times").on("click", (function() {
                $(".GamePlayer").addClass("transition-out"),
                setTimeout((function() {
                    $(".GamePlayer").removeClass("is-active transition-out"),
                    $("#Game").remove()
                }
                ), 500)
            }
            ...
            if (null != u) {
                ...
                function h() {
                    ...
                    a.height * m < a.width ? (c = a.height * m,
                    l = a.height) : a.width / m < a.height && (l = a.width / m,
                    c = a.width),
                    u.height(Math.floor(l)),
                    u.width(Math.floor(c))
                }
            ...
            window.Hacksaw = function(e) {
                ...
                t.set = (e, t) => {
                    if ("object" == typeof e)
                        ...
                        "string" == typeof e && (a[e] = t)
                }
                ,
                t.get = e => a[e] || "",
                t.data = e => n[e] || "",
                t.url = e => (e = "/" + t.get("language") + "/" + e).split("").reverse().join("").replace(/(\/{2,})(?!:)/g, "/").split("").reverse().join(""),
                t.asset = e => (t.get("assets_url") + e).split("").reverse().join("").replace(/(\/{2,})(?!:)/g, "/").split("").reverse().join(""),
                t.matchArrays = (e, a) => {
                    for (var t = [], n = 0; n < a.length; n++)
                        -1 !== e.indexOf(a[n]) && t.push(a[n]);
                    return t
                }
                ,
                t.convertHex = (e, a) => (e = e.replace("#", ""),
                "rgba(" + parseInt(e.substring(0, 2), 16) + "," + parseInt(e.substring(2, 4), 16) + "," + parseInt(e.substring(4, 6), 16) + "," + a / 100 + ")"),
                t.number_format = function(e, a, t, n) {
                    ...
                    var s = isFinite(+e) ? +e : 0
                      ...
                      , d = void 0 === t ? "." : t
                      , _ = "";
                    return _ = (r ? function(e, a) {
                        var t = Math.pow(10, a);
                        return "" + Math.round(e * t) / t
                    }(s, r) : "" + Math.round(s)).split("."),
                    (_[1] || "").length < r && _[0] > 0 && (_[1] = _[1] || "",
                    _[1] += new Array(r - _[1].length + 1).join("0")),
                    _[0].length > 3 && (_[0] = _[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, i)),
                    _.join(d)
                }
                ,
                t.modal = a => {
                    ...
                    t.modal.onShow = "function" == typeof a.onShow ? a.onShow : function() {}
                    ,
                    t.modal.onHide = "function" == typeof a.onHide ? a.onHide : function() {}
                    ,
                    null == t.modal.$modal && (t.modal.$modal = e('<div class="modal fade"><div class="modal-dialog"><div class="modal-content"></div></div></div>').appendTo("body"),
                    t.modal.$modal.on("shown.bs.modal", (function(e) {
                        t.modal.onShow.call(this, e)
                    }
                    )),
                    t.modal.$modal.on("hidden.bs.modal", (function(e) {
                        t.modal.onHide.call(this, e)
                    }
                    )));
                    t.modal.$modal.data("bs.modal", !1),
                    t.modal.$modal.find(".modal-dialog").removeClass().addClass("modal-dialog " + ({
                        small: "modal-sm",
                        large: "modal-lg"
                    }[a.size] || "")),
                    t.modal.$modal.find(".modal-content").html('<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">${title}</h4></div><div class="modal-body">${body}</div><div class="modal-footer"></div>'.replace("${title}", a.title).replace("${body}", a.body));
                    var n = t.modal.$modal.find(".modal-footer");
                    if ("[object Array]" == Object.prototype.toString.call(a.actions))
                        for (var s = 0, r = a.actions.length; s < r; s++)
                            a.actions[s].onClick = "function" == typeof a.actions[s].onClick ? a.actions[s].onClick : function() {}
                            ,
                            e('<button type="button" class="btn ' + (a.actions[s].cssClass || "") + '">' + (a.actions[s].label || "{Label Missing!}") + "</button>").appendTo(n).on("click", a.actions[s].onClick);
                    else
                        e('<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>').appendTo(n);
                    t.modal.$modal.modal(a)
                }
                ,
                t.Routing = {
                    exec: (e, a) => {
                        var n = t.routes;
                        a = void 0 === a ? "init" : a,
                        "" !== e && n[e] && "function" == typeof n[e][a] && n[e][a]()
                    }
                    ,
                    init: () => {
                        var e = document.body
                          , a = e.getAttribute("data-controller")
                          , n = e.getAttribute("data-action");
                        t.Routing.exec("common"),
                        t.Routing.exec(a),
                        t.Routing.exec(a, n)
                    }
                },
        ...
        5727: function(e, a, t) {
            ...
            Hacksaw.routes.home = {
                init: () => {
                    ...
                    s.p6)();
                    function a() {
                        $(".js-video-data").data("video").forEach((a => {
                            !function(a) {
                                const t = $(".js-video-data").data("video-url")
                                  , n = `<video title="${a.Title}" class="hero-bg-video hero-bg-media" playsinline="" loop="" muted="" autoplay="">\n                        <source id="video-src-${a.VideoId}" class="mp4 desktop" src="${t + ("portrait" == e ? a.VideoMobileFilename : a.VideoFilename)}" type="video/mp4">\n                    </video>`;
                                $(".video-id-" + a.VideoId).html(n)
                            }(a)
                        }
                        ))
                    }
                    $(".js-hero-scroll-down-indicator").on("click", (e => {
                        $("html, body").animate({
                            scrollTop: $("#js-hero-scroll-down-indicator-section").offset().top
                        }, "fast")
                    }
                    )),
                    (0,
                    n.q)(),
                    $(".js-video-data").length > 0 && (a(),
        ...
        3048: function(e, a, t) {
            ...
            var n = t(381)
              , s = t.n(n);
            Hacksaw.routes.news = {
                getNewsItems: async function(e) {
                    const a = $(e).data("offset")
                      , t = $(e).data("thumbnail-url");
                    $(e).remove();
                    try {
                        const e = await fetch(`${window.location.href}/get-news-by-offset?offset=${a}`)
                          , n = await e.json();
                        let r = "";
                        $(n).each(( (e, a) => {
                            const n = a.thumbnailFilename.length > 0 ? `<img class="NewsList__Image" src="${t}/${a.thumbnailFilename}">` : "";
                            r += `<li class="NewsList__Item dark">\n                    <a href="${window.location.href}/${a.slug}">\n                        <div class="NewsList__ItemWrapper">\n                            <div class="NewsList__ImageWrapper">\n                            ${n}\n                            </div>\n                            <div class="NewsList__CardTextWrapper">\n                                <div class="NewsList__CardTop">\n                                    <div class="NewsList__CardTop__inner">\n                                        <div class="NewsTitle"><h2>${a.title}</h2></div>\n                                    </div>\n                                    <div class="NewsList__CardMiddle">\n                                        <p class="NewsText">${a.teaserText}</p>\n                                    </div>\n                                </div>\n                                <div class="NewsList__CardBottom">\n                                    <p class="NewsText__ReadMore">Read more</p>\n                                    <div class="NewsDate">${s()(a.date).format("yyyy.MM.DD")}</div>\n                                </div>\n                            </div>\n                        </div>\n                    </a>\n                </li>`
                        }
                        )),
                        $(".js-news-list").append(r);
                        const i = `<button data-thumbnail-url="${t}" data-offset="${a + n.length}" onclick="window.Hacksaw.routes.news.getNewsItems(this)" class="Button Button--primary LoadMoreBtn" style="margin-top: 70px;" href="javascript:void(0);">Load more</a>`;
                        $(".js-news-wrapper").append(i)
                    } catch (e) {
                        console.log(e)
                    }
                }
        ...
        1905: function() {
            Hacksaw.routes.partners = {
                init: () => {
                    const e = document.querySelectorAll(".lazy-img")
                      , a = new IntersectionObserver((e => {
                        e.forEach((e => {
                            if (e.isIntersecting) {
                                const t = e.target.getAttribute("data-src");
                                e.target.src = t,
                                a.unobserve(e.target)
                            }
                        }
        ...
        8991: function(e, a, t) {
            ...
            const n = {
                ...
                googleAnalytics: {
                    id: "UA-112538731-1",
                    link: "https://www.googletagmanager.com/gtag/js"
                },
                bannerId: "CookieConsentModal"
            };
            function s() {
                return window.innerHeight > window.innerWidth ? "portrait" : "landscape"
            }
            function r(e, a, t=365, n=!1, s="Strict") {
                let r = "";
                if (t) {
                    r = `expires=${new Date(Date.now() + 24 * t * 60 * 60 * 1e3).toUTCString()}; `
                }
                let i = `${e}=${encodeURIComponent(a)}; ${r}path=/; SameSite=${s};`;
                n && (i += " Secure;"),
                document.cookie = i
            }
            function i(e) {
                return document.cookie.split("; ").find((a => a.startsWith(e + "=")))?.split("=")[1] || null
            }
            function d() {
                const e = document.getElementById(n.bannerId);
                e && e.classList.toggle("active", !1)
            }
            function _() {
                r(n.cookies.default.name, n.cookies.default.values.accepted, 30),
                u(),
            ...
            function o() {
                r(n.cookies.default.name, n.cookies.default.values.denied, 30),
                "function" == typeof gtag && gtag("consent", "update", {
                    analytics_storage: "denied"
                })
            }
            function u() {
                const e = i(n.cookies.default.name);
                if (!window.gaLoaded && e === n.cookies.default.values.accepted) {
                    const e = document.createElement("script");
                    e.src = `${n.googleAnalytics.link}?id=${n.googleAnalytics.id}`,
                    e.async = !0,
            ...
            function m(e) {
                i(e.name) === e.values.accepted ? (u(),
                d()) : function() {
                    const e = document.getElementById(n.bannerId);
                    e && e.classList.toggle("active", !0)
                }()
            }
        },
        472: function() {},
        ...
        9808: function(e, a, t) {
            !function(e) {
                ...
                function t(e, t, n) {
                    return "m" === n ? t ? "хвіліна" : "хвіліну" : "h" === n ? t ? "гадзіна" : "гадзіну" : e + " " + a({
        ...
        5822: function(e, a, t) {
            !function(e) {
                ...
                function i(e, a, t, n) {
                    ...
                    case "ss":
                        return a || n ? s + (r(e) ? "sekundy" : "sekund") : s + "sekundami";
                    case "m":
        ...
        135: function(e, a, t) {
            !function(e) {
                ...
                function t(e, t, n, s) {
                    ...
                    case "ss":
                        return a(e) ? r + (t || s ? "sekúndur" : "sekúndum") : r + "sekúnda";
                    case "m":
                        return t ? "mínúta" : "mínútu";
                    case "mm":
                        return a(e) ? r + (t || s ? "mínútur" : "mínútum") : t ? r + "mínúta" : r + "mínútu";
                    case "hh":
                        return a(e) ? r + (t || s ? "klukkustundir" : "klukkustundum") : r + "klukkustund";
                    case "d":
                        return t ? "dagur" : s ? "dag" : "degi";
                    case "dd":
                        return a(e) ? t ? r + "dagar" : r + (s ? "daga" : "dögum") : t ? r + "dagur" : r + (s ? "dag" : "degi");
                    case "M":
                        return t ? "mánuður" : s ? "mánuð" : "mánuði";
                    case "MM":
                        return a(e) ? t ? r + "mánuðir" : r + (s ? "mánuði" : "mánuðum") : t ? r + "mánuður" : r + (s ? "mánuð" : "mánuði");
                    case "y":
                        return t || s ? "ár" : "ári";
                    case "yy":
                        return a(e) ? r + (t || s ? "ár" : "árum") : r + (t || s ? "ár" : "ári")
                    }
                }
                e.defineLocale("is", {
        ...
        7010: function(e, a, t) {
            !function(e) {
                ...
                function i(e, a, t, i) {
                    var d = e + " ";
                    return 1 === e ? d + n(e, a, t[0], i) : a ? d + (s(e) ? r(t)[1] : r(t)[0]) : i ? d + r(t)[1] : d + (s(e) ? r(t)[1] : r(t)[2])
                }
                e.defineLocale("lt", {
                    months: {
        ...
        1793: function(e, a, t) {
            !function(e) {
                ...
                function t(e, t, n) {
                    return "m" === n ? t ? "минута" : "минуту" : e + " " + a({
                        ss: t ? "секунда_секунды_секунд" : "секунду_секунды_секунд",
        ...
        4249: function(e, a, t) {
            !function(e) {
                ...
                function s(e, a, t, s) {
                    ...
                    case "ss":
                        return a || s ? r + (n(e) ? "sekundy" : "sekúnd") : r + "sekundami";
                    case "m":
                    ...
                    case "MM":
                        return a || s ? r + (n(e) ? "mesiace" : "mesiacov") : r + "mesiacmi";
                    case "y":
            ...
            !function(e) {
                ...
                var a = {
                    ...
                    translate: function(e, t, n, s) {
                        var r, i = a.words[n];
                        return 1 === n.length ? "y" === n && t ? "једна година" : s || t ? i[0] : i[1] : (r = a.correctGrammaticalCase(e, i),
                        "yy" === n && t && "годину" === r ? e + " година" : e + " " + r)
                    }
                };
        ...
        9131: function(e, a, t) {
            !function(e) {
                ...
                var a = {
                    ...
                    translate: function(e, t, n, s) {
                        var r, i = a.words[n];
                        return 1 === n.length ? "y" === n && t ? "jedna godina" : s || t ? i[0] : i[1] : (r = a.correctGrammaticalCase(e, i),
                        "yy" === n && t && "godinu" === r ? e + " godina" : e + " " + r)
                    }
                };
                e.defineLocale("sr", {
                    months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split("_"),
        ...
        7691: function(e, a, t) {
            !function(e) {
                ...
                function t(e, t, n) {
                    return "m" === n ? t ? "хвилина" : "хвилину" : "h" === n ? t ? "година" : "годину" : e + " " + a({
            ...
            (e = t.nmd(e)).exports = function() {
                ...
                function v(e, a) {
                    ...
                    return h((function() {
                        ...
                        t) {
                            var n, r, i, d = [], o = arguments.length;
                            for (r = 0; r < o; r++) {
                                if (n = "",
                                "object" == typeof arguments[r]) {
                                    for (i in n += "\n[" + r + "] ",
                                    arguments[0])
                                        _(arguments[0], i) && (n += i + ": " + arguments[0][i] + ", ");
                                    n = n.slice(0, -2)
                                } else
                                    n = arguments[r];
                                d.push(n)
                ...
                function P(e, a) {
                    var t, n = h({}, e);
                    for (t in a)
                        _(a, t) && (d(e[t]) && d(a[t]) ? (n[t] = {},
                        h(n[t], e[t]),
                        h(n[t], a[t])) : null != a[t] ? n[t] = a[t] : delete n[t]);
                    for (t in e)
                        _(e, t) && !_(a, t) && d(e[t]) && (n[t] = h({}, n[t]));
                    return n
                }
                function O(e) {
                    null != e && this.set(e)
                ...
                function I(e) {
                    ...
                    for (a = 0,
                    t = n.length; a < t; a++)
                        J[n[a]] ? n[a] = J[n[a]] : n[a] = R(n[a]);
                    return function(a) {
                        var s, r = "";
                        for (s = 0; s < t; s++)
                            r += j(n[s]) ? n[s].call(a, e) : n[s];
                        return r
                    }
                }
                function $(e, a) {
                ...
                function Le(e, a) {
                    if ("object" == typeof e) {
                        var t, n = _e(e = re(e)), s = n.length;
                        for (t = 0; t < s; t++)
                            this[n[t].unit](e[n[t].unit])
                    } else if (j(this[e = se(e)]))
                        return this[e](a);
                    return this
                }
                var Ye, ye = /\d/, fe = /\d\d/, pe = /\d{3}/, ke = /\d{4}/, De = /[+-]?\d{6}/, ge = /\d\d?/, we = /\d\d\d\d?/, Te = /\d\d\d\d\d\d?/, ve = /\d{1,3}/, be = /\d{1,4}/, Se = /[+-]?\d{1,6}/, He = /\d+/, je = /[+-]?\d+/, xe = /Z|[+-]\d\d:?\d\d/gi, Pe = /Z|[+-]\d\d(?::?\d\d)?/gi, Oe = /[+-]?\d+(\.\d{1,3})?/, We = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
                function Ae(e, a, t) {
                    Ye[e] = j(a) ? a : function(e, n) {
                        return e && t ? t : a
                    }
                }
                function Ee(e, a) {
                ...
                function Fe(e) {
                    return ze(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, (function(e, a, t, n, s) {
                        return a || t || n || s
                    }
                    )))
                }
                ...
                var Ie, $e = 0, Ge = 1, Ue = 2, Ve = 3, Be = 4, qe = 5, Ke = 6, Ze = 7, Qe = 8;
                function Xe(e, a) {
                    return (e % a + a) % a
                }
                function ea(e, a) {
                ...
                var aa = "January_February_March_April_May_June_July_August_September_October_November_December".split("_")
                  ...
                  , ra = We;
                function ia(e, a) {
                    return e ? i(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || na).test(a) ? "format" : "standalone"][e.month()] : i(this._months) ? this._months : this._months.standalone
                }
                function da(e, a) {
                    return e ? i(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[na.test(a) ? "format" : "standalone"][e.month()] : i(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
                }
                function _a(e, a, t) {
                    ...
                    return t ? "MMM" === a ? -1 !== (s = Ie.call(this._shortMonthsParse, i)) ? s : null : -1 !== (s = Ie.call(this._longMonthsParse, i)) ? s : null : "MMM" === a ? -1 !== (s = Ie.call(this._shortMonthsParse, i)) || -1 !== (s = Ie.call(this._longMonthsParse, i)) ? s : null : -1 !== (s = Ie.call(this._longMonthsParse, i)) || -1 !== (s = Ie.call(this._shortMonthsParse, i)) ? s : null
                }
                function oa(e, a, t) {
                    var n, s, r;
                    ...
                    n = 0; n < 12; n++) {
                        if (s = M([2e3, n]),
                        t && !this._longMonthsParse[n] && (this._longMonthsParse[n] = new RegExp("^" + this.months(s, "").replace(".", "") + "$","i"),
                        this._shortMonthsParse[n] = new RegExp("^" + this.monthsShort(s, "").replace(".", "") + "$","i")),
                        t || this._monthsParse[n] || (r = "^" + this.months(s, "") + "|^" + this.monthsShort(s, ""),
                ...
                function ca(e) {
                    return this._monthsParseExact ? (_(this, "_monthsRegex") || Ma.call(this),
                    e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (_(this, "_monthsShortRegex") || (this._monthsShortRegex = sa),
                ...
                Je("YYYY", (function(e, a) {
                    a[$e] = 2 === e.length ? s.parseTwoDigitYear(e) : me(e)
                }
                )),
                Je("YY", (function(e, a) {
                    a[$e] = s.parseTwoDigitYear(e)
                }
                )),
                Je("Y", (function(e, a) {
                    a[$e] = parseInt(e, 10)
                ...
                function fa(e, a, t, n, s, r, i) {
                    var d;
                    return e < 100 && e >= 0 ? (d = new Date(e + 400,a,t,n,s,r,i),
                    isFinite(d.getFullYear()) && d.setFullYear(e)) : d = new Date(e,a,t,n,s,r,i),
                    d
                }
                function pa(e) {
                    var a, t;
                ...
                function Da(e, a, t, n, s) {
                    var r, i, d = 1 + 7 * (a - 1) + (7 + t - n) % 7 + ka(e, n, s);
                ...
                function ga(e, a, t) {
                    var n, s, r = ka(e.year(), a, t), i = Math.floor((e.dayOfYear() - r - 1) / 7) + 1;
                    return i < 1 ? n = i + wa(s = e.year() - 1, a, t) : i > wa(e.year(), a, t) ? (n = i - wa(e.year(), a, t),
                    s = e.year() + 1) : (s = e.year(),
                    n = i),
                    {
                        week: n,
                ...
                function $a(e, a, t) {
                    ...
                    n = 0; n < 7; n++) {
                        if (s = M([2e3, 1]).day(n),
                        t && !this._fullWeekdaysParse[n] && (this._fullWeekdaysParse[n] = new RegExp("^" + this.weekdays(s, "").replace(".", "\\.?") + "$","i"),
                ...
                function Ba(e) {
                    return this._weekdaysParseExact ? (_(this, "_weekdaysRegex") || Za.call(this),
                ...
                function lt(e) {
                    for (var a, t, n, s, r = 0; r < e.length; ) {
                        for (a = (s = mt(e[r]).split("-")).length,
                        t = (t = mt(e[r + 1])) ? t.split("-") : null; a > 0; ) {
                            if (n = ht(s.slice(0, a).join("-")))
                                return n;
                            if (t && t.length >= a && ut(s, t) >= a - 1)
                                break;
                            a--
                        }
                        r++
                ...
                function ht(a) {
                    var n = null;
                    if (void 0 === _t[a] && e && e.exports && ct(a))
                        try {
                            n = it._abbr,
                            t(6700)("./" + a),
                            Mt(n)
                ...
                function Yt(e, a) {
                    if (null != a) {
                        var t, n, s = dt;
                        null != _t[e] && null != _t[e].parentLocale ? _t[e].set(P(_t[e]._config, a)) : (null != (n = ht(e)) && (s = n._config),
                        a = P(s, a),
                        null == n && (a.abbr = e),
                        ...
                        e === Mt() && Mt(e)) : null != _t[e] && delete _t[e]);
                    return _t[e]
                }
                function yt(e) {
                    var a;
                ...
                function pt(e) {
                    var a, t = e._a;
                    return t && -2 === Y(e).overflow && (a = t[Ge] < 0 || t[Ge] > 11 ? Ge : t[Ue] < 1 || t[Ue] > ea(t[$e], t[Ge]) ? Ue : t[Ve] < 0 || t[Ve] > 24 || 24 === t[Ve] && (0 !== t[Be] || 0 !== t[qe] || 0 !== t[Ke]) ? Ve : t[Be] < 0 || t[Be] > 59 ? Be : t[qe] < 0 || t[qe] > 59 ? qe : t[Ke] < 0 || t[Ke] > 999 ? Ke : -1,
                    Y(e)._overflowDayOfYear && (a < $e || a > Ue) && (a = Ue),
                    Y(e)._overflowWeeks && -1 === a && (a = Ze),
                ...
                var kt = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/
                  ...
                  , Tt = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]]
                  , vt = /^\/?Date\((-?\d+)/i
                ...
                function Ht(e) {
                    var a, t, n, s, r, i, d = e._i, _ = kt.exec(d) || Dt.exec(d), o = wt.length, u = Tt.length;
                    if (_) {
                        for (Y(e).iso = !0,
                        a = 0,
                        t = o; a < t; a++)
                ...
                function jt(e, a, t, n, s, r) {
                    var i = [xt(e), ta.indexOf(a), parseInt(t, 10), parseInt(n, 10), parseInt(s, 10)];
                ...
                function Et(e) {
                    ...
                    At(e),
                    !1 === e._isValid && (delete e._isValid,
                    e._strict ? e._isValid = !1 : s.createFromInputFallback(e)))) : e._d = new Date(+a[1])
                }
                function Ft(e, a, t) {
                ...
                function Jt(e) {
                    ...
                    i = 4,
                    t = Ft(a.GG, e._a[$e], ga(qt(), 1, 4).year),
                    n = Ft(a.W, 1),
                    ((s = Ft(a.E, 1)) < 1 || s > 7) && (_ = !0)) : (r = e._locale._week.dow,
                    i = e._locale._week.doy,
                    o = ga(qt(), r, i),
                    t = Ft(a.gg, e._a[$e], o.year),
                    n = Ft(a.w, o.week),
                    null != a.d ? ((s = a.d) < 0 || s > 6) && (_ = !0) : null != a.e ? (s = a.e + r,
                    (a.e < 0 || a.e > 6) && (_ = !0)) : s = r),
                    n < 1 || n > wa(t, r, i) ? Y(e)._overflowWeeks = !0 : null != _ ? Y(e)._overflowWeekday = !0 : (d = Da(t, n, s, r, i),
                    e._a[$e] = d.year,
                ...
                function Ct(e) {
                    if (e._f !== s.ISO_8601)
                        if (e._f !== s.RFC_2822) {
                            e._a = [],
                            Y(e).empty = !0;
                            var a, t, n, r, i, d, _, o = "" + e._i, u = o.length, m = 0;
                            for (_ = (n = G(e._f, e._locale).match(F) || []).length,
                            a = 0; a < _; a++)
                                r = n[a],
                                ...
                                Re(r, t, e)) : e._strict && !t && Y(e).unusedTokens.push(r);
                            Y(e).charsLeftOver = u - m,
                            o.length > 0 && Y(e).unusedInput.push(o),
                            e._a[Ve] <= 12 && !0 === Y(e).bigHour && e._a[Ve] > 0 && (Y(e).bigHour = void 0),
                            Y(e).parsedDateParts = e._a.slice(0),
                            Y(e).meridiem = e._meridiem,
                            e._a[Ve] = Rt(e._locale, e._a[Ve], e._meridiem),
                            null !== (d = Y(e).era) && (e._a[$e] = e._locale.erasConvertYear(d, e._a[$e])),
                            Nt(e),
                            pt(e)
                        } else
                            At(e);
                ...
                function It(e) {
                    var a, t, n, s, r, i, d = !1, _ = e._f.length;
                    if (0 === _)
                ...
                function $t(e) {
                    if (!e._d) {
                        ...
                        e._a = c([a.year, a.month, t, a.hour, a.minute, a.second, a.millisecond], (function(e) {
                ...
                function Ut(e) {
                    ...
                    w(a) ? new g(pt(a)) : (l(a) ? e._d = a : i(t) ? It(e) : t ? Ct(e) : Vt(e),
                    y(e) || (e._d = null),
                    e))
                }
                function Vt(e) {
                    var a = e._i;
                    u(a) ? e._d = new Date(s.now()) : l(a) ? e._d = new Date(a.valueOf()) : "string" == typeof a ? Et(e) : i(a) ? (e._a = c(a.slice(0), (function(e) {
                        return parseInt(e, 10)
                    }
                    )),
                    Nt(e)) : d(a) ? $t(e) : m(a) ? e._d = new Date(a) : s.createFromInputFallback(e)
                }
                ...
                s.RFC_2822 = function() {}
                ;
                var Kt = v("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", (function() {
                    var e = qt.apply(null, arguments);
                    return this.isValid() && e.isValid() ? e < this ? this : e : f()
                }
                ))
                  , Zt = v("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", (function() {
                    var e = qt.apply(null, arguments);
                    return this.isValid() && e.isValid() ? e > this ? this : e : f()
                }
                ));
                ...
                function nn(e) {
                    var a, t, n = !1, s = tn.length;
                    for (a in e)
                        if (_(e, a) && (-1 === Ie.call(tn, a) || null != e[a] && isNaN(e[a])))
                            return !1;
                    for (t = 0; t < s; ++t)
                        if (e[tn[t]]) {
                            if (n)
                ...
                function un(e, a, t) {
                    var n, s = Math.min(e.length, a.length), r = Math.abs(e.length - a.length), i = 0;
                    for (n = 0; n < s; n++)
                ...
                function cn(e, a) {
                    var t, n, s = (a || "").match(e);
                    return null === s ? null : 0 === (n = 60 * (t = ((s[s.length - 1] || []) + "").match(ln) || ["-", 0, 0])[1] + me(t[2])) ? 0 : "+" === t[0] ? n : -n
                }
                function hn(e, a) {
                    var t, n;
                    return a._isUTC ? (t = a.clone(),
                    n = (w(e) || l(e) ? e.valueOf() : qt(e).valueOf()) - t.valueOf(),
                ...
                function Ln(e, a, t) {
                    ...
                    if (null != e) {
                        ...
                        return !this._isUTC && a && (n = Mn(this)),
                        this._offset = e,
                        this._isUTC = !0,
                        null != n && this.add(n, "m"),
                        r !== e && (!a || this._changeInProgress ? Wn(this, Hn(e - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
                        s.updateOffset(this, !0),
                ...
                function gn() {
                    ...
                    var e, a = {};
                    return D(a, this),
                    (a = Ut(a))._a ? (e = a._isUTC ? M(a._a) : qt(a._a),
                    this._isDSTShifted = this.isValid() && un(a._a, e.toArray()) > 0) : this._isDSTShifted = !1,
                    this._isDSTShifted
                }
                function wn() {
                ...
                function Hn(e, a) {
                    var t, n, s, r = e, i = null;
                    return _n(e) ? r = {
                        ms: e._milliseconds,
                        d: e._days,
                        M: e._months
                    } : m(e) || !isNaN(+e) ? (r = {},
                    a ? r[a] = +e : r.milliseconds = +e) : (i = bn.exec(e)) ? (t = "-" === i[1] ? -1 : 1,
                    r = {
                        y: 0,
                        d: me(i[Ue]) * t,
                        h: me(i[Ve]) * t,
                    ...
                    r = {
                        ...
                        m: jn(i[7], t),
                        s: jn(i[8], t)
                    }) : null == r ? r = {} : "object" == typeof r && ("from"in r || "to"in r) && (s = Pn(qt(r.from), qt(r.to)),
                    (r = {}).ms = s.milliseconds,
                    r.M = s.months),
                    n = new dn(r),
                ...
                function Pn(e, a) {
                    var t;
                    return e.isValid() && a.isValid() ? (a = hn(a, e),
                    e.isBefore(a) ? t = xn(e, a) : ((t = xn(a, e)).milliseconds = -t.milliseconds,
                    t.months = -t.months),
                    t) : {
                        milliseconds: 0,
                        months: 0
                ...
                function On(e, a) {
                    return function(t, n) {
                        var s;
                        return null === n || isNaN(+n) || (H(a, "moment()." + a + "(period, number) is deprecated. Please use moment()." + a + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
                        s = t,
                        t = n,
                        n = s),
                        Wn(this, Hn(t, n), e),
                ...
                function Wn(e, a, t, n) {
                    ...
                    d && ua(e, ce(e, "Month") + d * t),
                    i && he(e, "Date", ce(e, "Date") + i * t),
                ...
                function zn(e) {
                    return w(e) || l(e) || Fn(e) || m(e) || Jn(e) || Nn(e) || null == e
                }
                function Nn(e) {
                    var a, t, n = d(e) && !o(e), s = !1, r = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"], i = r.length;
                    for (a = 0; a < i; a += 1)
                        t = r[a],
                        s = s || _(e, t);
                    return n && s
                ...
                function Cn(e) {
                    var a, t, n = d(e) && !o(e), s = !1, r = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"];
                ...
                function In(e, a) {
                    1 === arguments.length && (arguments[0] ? zn(arguments[0]) ? (e = arguments[0],
                    a = void 0) : Cn(arguments[0]) && (a = arguments[0],
                    e = void 0) : (e = void 0,
                    a = void 0));
                    var t = e || qt()
                ...
                function Vn(e, a, t, n) {
                    var s = w(e) ? e : qt(e)
                      , r = w(a) ? a : qt(a);
                    return !!(this.isValid() && s.isValid() && r.isValid()) && ("(" === (n = n || "()")[0] ? this.isAfter(s, t) : !this.isBefore(s, t)) && (")" === n[1] ? this.isBefore(r, t) : !this.isAfter(r, t))
                }
                function Bn(e, a) {
                    var t, n = w(e) ? e : qt(e);
                    return !(!this.isValid() || !n.isValid()) && ("millisecond" === (a = se(a) || "millisecond") ? this.valueOf() === n.valueOf() : (t = n.valueOf(),
                ...
                function es(e) {
                    ...
                    return t.year() < 0 || t.year() > 9999 ? $(t, a ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : j(Date.prototype.toISOString) ? a ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", $(t, "Z")) : $(t, a ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
                }
                function as() {
                    if (!this.isValid())
                        return "moment.invalid(/* " + this._i + " */)";
                    var e, a, t, n, s = "moment", r = "";
                ...
                function ns(e, a) {
                    return this.isValid() && (w(e) && e.isValid() || qt(e).isValid()) ? Hn({
                        to: this,
                        from: e
                ...
                var _s = v("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", (function(e) {
                ...
                function Ms(e, a, t) {
                    return e < 100 && e >= 0 ? new Date(e + 400,a,t) - cs : new Date(e,a,t).valueOf()
                }
                function Ls(e, a, t) {
                    return e < 100 && e >= 0 ? Date.UTC(e + 400, a, t) - cs : Date.UTC(e, a, t)
                }
                function Ys(e) {
                    var a, t;
                    if (void 0 === (e = se(e)) || "millisecond" === e || !this.isValid())
                        return this;
                    switch (t = this._isUTC ? Ls : Ms,
                    e) {
                    case "year":
                        a = t(this.year(), 0, 1);
                        break;
                ...
                function ys(e) {
                    ...
                    case "hour":
                        a = this._d.valueOf(),
                        a += ls - hs(a + (this._isUTC ? 0 : this.utcOffset() * ms), ls) - 1;
                        break;
                    case "minute":
                        a = this._d.valueOf(),
                        a += ms - hs(a, ms) - 1;
                ...
                function Hs(e, a) {
                    var t, n, r, i = this._eras || yt("en")._eras;
                    for (t = 0,
                    n = i.length; t < n; ++t)
                        switch ("string" == typeof i[t].since && (r = s(i[t].since).startOf("day"),
                        i[t].since = r.valueOf()),
                        typeof i[t].until) {
                        case "undefined":
                            i[t].until = 1 / 0;
                ...
                function xs(e, a) {
                    ...
                    return void 0 === a ? s(e.since).year() : s(e.since).year() + (a - e.offset) * t
                }
                function Ps() {
                ...
                function As() {
                    var e, a, t, n, r = this.localeData().eras();
                    for (e = 0,
                    a = r.length; e < a; ++e)
                ...
                function Es(e) {
                    return _(this, "_erasNameRegex") || Is.call(this),
                    e ? this._erasNameRegex : this._erasRegex
                }
                function Fs(e) {
                    return _(this, "_erasAbbrRegex") || Is.call(this),
                    e ? this._erasAbbrRegex : this._erasRegex
                }
                function zs(e) {
                    return _(this, "_erasNarrowRegex") || Is.call(this),
                ...
                function Bs() {
                    return wa(this.isoWeekYear(), 1, 4)
                }
                function qs() {
                    var e = this.localeData()._week;
                    return wa(this.year(), e.dow, e.doy)
                }
                function Ks() {
                    var e = this.localeData()._week;
                    return wa(this.weekYear(), e.dow, e.doy)
                }
                function Zs(e, a, t, n, s) {
                    var r;
                    return null == e ? ga(this, n, s).year : (a > (r = wa(e, n, s)) && (a = r),
                    Qs.call(this, e, a, t, n, s))
                }
                ...
                Je(["yo"], (function(e, a, t, n) {
                    var s;
                    t._locale._eraYearOrdinalRegex && (s = e.match(t._locale._eraYearOrdinalRegex)),
                    t._locale.eraYearOrdinalParse ? a[$e] = t._locale.eraYearOrdinalParse(e, s) : a[$e] = parseInt(e, 10)
                }
                )),
                C(0, ["gg", 2], 0, (function() {
                ...
                Ae("GGGGG", Se, De),
                Ae("ggggg", Se, De),
                Ce(["gggg", "ggggg", "GGGG", "GGGGG"], (function(e, a, t, n) {
                    a[n.substr(0, 2)] = me(e)
                }
                )),
                Ce(["gg", "GG"], (function(e, a, t, n) {
                ...
                or.zone = v("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Yn),
                or.isDSTShifted = v("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", gn);
                var cr = O.prototype;
                function hr(e, a, t, n) {
                    var s = yt()
                      , r = M().set(n, a);
                ...
                function Lr(e, a, t, n) {
                    ...
                    a = void 0),
                    a = a || "");
                    var s, r = yt(), i = e ? r._week.dow : 0, d = [];
                    if (null != t)
                        return hr(a, (t + i) % 7, n, "day");
                    for (s = 0; s < 7; s++)
                        d[s] = hr(a, (s + i) % 7, n, "day");
                    return d
                }
                function Yr(e, a) {
                    return Mr(e, a, "months")
                }
                function yr(e, a) {
                    return Mr(e, a, "monthsShort")
                }
                function fr(e, a, t) {
                ...
                cr.monthsParse = oa,
                cr.monthsRegex = ha,
                cr.monthsShortRegex = ca,
                cr.week = Ta,
                cr.firstDayOfYear = Sa,
                cr.firstDayOfWeek = ba,
                cr.weekdays = Ja,
                cr.weekdaysMin = Ra,
                cr.weekdaysShort = Ca,
                cr.weekdaysParse = $a,
                cr.weekdaysRegex = Ba,
                cr.weekdaysShortRegex = qa,
                cr.weekdaysMinRegex = Ka,
                cr.isPM = tt,
                cr.meridiem = rt,
                Mt("en", {
                    eras: [{
                ...
                s.langData = v("moment.langData is deprecated. Use moment.localeData instead.", yt);
                var Dr = Math.abs;
                function gr() {
                    var e = this._data;
                ...
                function Sr() {
                    var e, a, t, n, s, r = this._milliseconds, i = this._days, d = this._months, _ = this._data;
                ...
                function oi() {
                    if (!this.isValid())
                        return this.localeData().invalidDate();
                    var e, a, t, n, s, r, i, d, _ = di(this._milliseconds) / 1e3, o = di(this._days), u = di(this._months), m = this.asSeconds();
                    return m ? (e = ue(_ / 60),
                    a = ue(e / 60),
                    _ %= 60,
                    e %= 60,
                    ...
                    s + "P" + (t ? r + t + "Y" : "") + (u ? r + u + "M" : "") + (o ? i + o + "D" : "") + (a || e || _ ? "T" : "") + (a ? d + a + "H" : "") + (e ? d + e + "M" : "") + (_ ? d + n + "S" : "")) : "P0D"
                }
                var ui = dn.prototype;
                return ui.isValid = sn,
                ui.abs = gr,
                ui.add = Tr,
                ui.subtract = vr,
                ui.as = xr,
    ...
    t.d = function(e, a) {
        for (var n in a)
            t.o(a, n) && !t.o(e, n) && Object.defineProperty(e, n, {
                enumerable: !0,
                get: a[n]
            })
    }
